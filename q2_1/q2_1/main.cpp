...
int main(int argc, char const *argv[])
{
    ...
    /* Load city names */
    fstream cityIn;
    cityIn.open("/Users/qybo123/Desktop/HW2/q2_1/cityList.txt");
    char tmp[20];
    while(cityIn >> tmp) {
        load(tmp);
    }
    ...
    /* Insert city pairs */
    ifstream pairIn;
    pairIn.open("/Users/qybo123/Desktop/HW2/q2_1/cityPairs.txt");
    char city1[20];
    char city2[20];
    ...
    ifstream reqIn;
    reqIn.open("/Users/qybo123/Desktop/HW2/q2_1/reqList.txt");
