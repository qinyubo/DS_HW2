...
int main(int argc, char const *argv[])
{
    ...
    /* Load city names */
    fstream cityIn;
    filename = file_dir + "cityNames.txt";
    cityIn.open(filename.c_str());
    char tmp[20];
    while(cityIn >> tmp) {
        load(tmp);
    }
    ...
    /* Insert city pairs */
    ifstream pairIn;
    filename = file_dir + "cityPairs.txt";
    pairIn.open(filename.c_str());
    char city1[20];
    char city2[20];
    ...
    ifstream reqIn;
    filename = file_dir + "searchList.txt";
    reqIn.open(filename.c_str());
